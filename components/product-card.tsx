...
interface ProductCardProps {
  product: {
    ...
    price: string
    image: string
    badge?: "New" | "Back in stock" | "Limited" | "Bestseller" | "Popular"
    materials: string[]
        ...
        <div className="absolute top-4 left-4 z-20">
          <span
            className={cn(
              ...
              product.badge === "Bestseller" && "bg-rose-500/90 text-white",
              product.badge === "Popular" && "bg-purple-500/90 text-white",
            )}
          >
            {product.badge}
          </span>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6">
        ...
        <div className="relative z-10">
          <div>
            ...
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium text-white border border-white/30">
              Request Quote
            </span>
          </div>
        </div>
